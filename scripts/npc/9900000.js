...
function action(mode, type, selection) {
	...
	if (cm.getPlayerStat("GM") == 0) {
	    cm.sendOk("Sorry, but only Game Masters with a GM Level of 3 or more can use this.");
	    cm.dispose();
	} else {
	...
	if (cm.getPlayerStat("GENDER") == 0) {
	    if (selection == 0) {
			beauty = 1;
			cm.askAvatar("Pick a skin color that you would like.", skin);
	    } else if (selection == 1) {
		beauty = 2;
		hairnew = Array();
		...
		cm.askAvatar("Pick a hairstyle that you would like.", hairnew);
	    } else if (selection == 2) {
		beauty = 3;
		haircolor = Array();
		...
		cm.askAvatar("Pick a hair color that you would like.", haircolor);
	    } else if (selection == 3) {
		beauty = 4;
		facenew = Array();
		...
		cm.askAvatar("Pick a new face that you would like.", facenew);
	    } else if (selection == 4) {
		beauty = 5;
		...
		cm.askAvatar("Pick a eye color that you would like.", colors);
	    }
	} else {
	    if (selection == 0) {
		beauty = 1;
		...
		cm.askAvatar("Pick new eyes that you would like.", facenew);
	    } else if (selection == 4) {
		beauty = 5;
