function init() {
    em.setProperty("TylusSummoned", "0");
}

function setup(eim, leaderid) {
    em.setProperty("TylusSummoned", "1");

    var eim = em.newInstance("ProtectTylus");

    var map = eim.getMapFactory(em.getWorld()).getMap(921100300);
...
function scheduledTimeout(eim) {
    eim.disposeIfPlayerBelow(0, 211000001);
