...
function setup() {
    ...
    waitingMap = mapf.getMap(980000600);
    reviveMap = mapf.getMap(980000602);
    fieldMap = mapf.getMap(980000601);
    winnerMap = mapf.getMap(980000603);
    loserMap = mapf.getMap(980000604);
    blueParty = null;
    redParty = null;
    var instanceName = "cpq6";
    eim = em.newInstance(instanceName);
    instanceId++;
    var portal = reviveMap.getPortal("pt00");
    portal.setScriptName("MCrevive6");
