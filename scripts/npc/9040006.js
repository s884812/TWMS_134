	...
	if (eim.getProperty("leader").equals(cm.getName())) {
		...
		if (currentCombo == null || currentCombo.equals("reset")) {
			...
			if (combo == guess) {
			    ...
			    var black = server.life.MapleLifeFactory.getMonster(9300036);
			    var myst = server.life.MapleLifeFactory.getMonster(9300037);
			    if (attempt < 7) {
				...
				cm.getMap().spawnMonsterOnGroundBelow(black, new java.awt.Point(-350, 150));
				cm.getMap().spawnMonsterOnGroundBelow(myst, new java.awt.Point(400, 150));
				...
				for (var i = 0; i < 5; i++) {
				    ...
				    black = server.life.MapleLifeFactory.getInstance().getMonster(9300036);
				    myst = server.life.MapleLifeFactory.getInstance().getMonster(9300037);
				    cm.getMap().spawnMonsterOnGroundBelow(black, new java.awt.Point(randX(), 150));
				    cm.getMap().spawnMonsterOnGroundBelow(myst, new java.awt.Point(randX(), 150));
				}
			    }
			}
		    } else {
