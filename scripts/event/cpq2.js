...
function setup() {
    ...
    waitingMap = mapf.getMap(980000200);
    reviveMap = mapf.getMap(980000202);
    fieldMap = mapf.getMap(980000201);
    winnerMap = mapf.getMap(980000203);
    loserMap = mapf.getMap(980000204);
    blueParty = null;
    redParty = null;
    var instanceName = "cpq2";
