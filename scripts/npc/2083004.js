...
function action(mode, type, selection) {
	...
	case 0:
	    if (mode == 1) {
		cm.registerSquad("Horntail", 5, " has been appointed as the Leader of the squad. If you would you like to join please register for the Expedition Squad within the time period.");
		cm.sendOk("You have been appointed the Leader of the Squad. For the next 5 minutes, you can add the members of the Expedition Squad.");
	    }
	    cm.dispose();
	    break;
	case 5:
