...
function start() {
    ...
    var eim_status = em.getProperty("started");
    if (eim_status.equals("true")) {
	cm.sendOk("The battle against the hass has already begun.");
	cm.dispose();
	return;
    }
...
function action(mode, type, selection) {
	...
	case 0:
	    if (mode == 1) {
		cm.registerSquad("PinkBean", 5, " has been named the Leader of the squad. If you would you like to join please register for the Expedition Squad within the time period.");
