...
function onDown() {
    em.getChannelServer().getMapFactory(em.getWorld()).getMap(222020100).resetReactors();
...
function goingUp() {
    ...
    em.getChannelServer().getMapFactory(em.getWorld()).getMap(222020100).setReactorState();
}

function onUp() {
    em.getChannelServer().getMapFactory(em.getWorld()).getMap(222020200).resetReactors();
...
function goingDown() {
    ...
    em.getChannelServer().getMapFactory(em.getWorld()).getMap(222020200).setReactorState();
}
