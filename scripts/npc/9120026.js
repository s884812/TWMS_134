...
function start() {
	...
	case 802000711:
	    ...
	    break;
	default:
	    cm.sendSimple("I am responsible for expanding Asia's vast strengths. If you have received permission from Asia on time warp, then I will send you to the past or future of Zipangu. \r #b#L0#Future - Odaiba, Tokyo, 2100#l \r #L1#Future - Tokyo Park, 2095#l \r #L2#Future - Akihabara, Tokyo, 2102#l \r #L3#Future - Tokyo Skies, 2102#l \r #L4#Future - Shibuya, Tokyo, 2102#l \r #L5#Future - Top Floor of Roppongi Mall, Tokyo, 2102l \r #L6#Past - Ninja Castle#l");
	    break;
    }
}
