...
function scheduleNew() {
    ...
    em.getMapFactory(em.getWorld()).getMap(200090000).killAllMonsters(false);
    em.getMapFactory(em.getWorld()).getMap(200090010).killAllMonsters(false);
}

function stopentry() {
    em.setProperty("entry","false");
    em.getMapFactory(em.getWorld()).getMap(200090011).resetReactors();
    em.getMapFactory(em.getWorld()).getMap(200090001).resetReactors();
}
...
function invasion() {
	...
	var map1 = em.getMapFactory(em.getWorld()).getMap(200090000);
	var pos1 = new java.awt.Point(-538, 143);
	map1.spawnMonsterOnGroundBelow(em.getMonster(8150000), pos1);
	map1.spawnMonsterOnGroundBelow(em.getMonster(8150000), pos1);

	var map2 = em.getMapFactory(em.getWorld()).getMap(200090010);
