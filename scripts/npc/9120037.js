...
function action(mode, type, selection) {
	...
	case 0:
	    if (mode == 1) {
		cm.registerSquad("Dunas", 5, " has been named the Leader of the squad. If you would you like to join please register for the Expedition Squad within the time period.");
