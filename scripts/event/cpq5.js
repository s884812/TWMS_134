...
function setup() {
    ...
    waitingMap = mapf.getMap(980000500);
    reviveMap = mapf.getMap(980000502);
    fieldMap = mapf.getMap(980000501);
    winnerMap = mapf.getMap(980000503);
    loserMap = mapf.getMap(980000504);
    blueParty = null;
    redParty = null;
