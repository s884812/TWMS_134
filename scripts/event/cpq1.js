...
function setup() {
    ...
    waitingMap = mapf.getMap(980000100);
    reviveMap = mapf.getMap(980000102);
    fieldMap = mapf.getMap(980000101);
    winnerMap = mapf.getMap(980000103);
    loserMap = mapf.getMap(980000104);
    blueParty = null;
    redParty = null;
    var instanceName = "cpq1";
