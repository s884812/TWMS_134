...
function action(mode, type, selection) {
	...
	case 0:
		...
		cm.sendPrev("The party leaders will be able to apply for the spot as the leader of the Expedition Squad.");
		cm.safeDispose();
	    }
	    break;
	case 1:
		...
		if (!balrogMode) { // Easy Mode
		    ...
		    if (lvl >= 50 && lvl <= 70) {
			cm.registerSquad("BossBalrog", 5, " has been named the Leader of the squad. If you would you like to join please register for the Expedition Squad within the time period.");
