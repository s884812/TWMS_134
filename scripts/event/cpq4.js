...
function setup() {
    ...
    waitingMap = mapf.getMap(980000400);
    reviveMap = mapf.getMap(980000402);
    fieldMap = mapf.getMap(980000401);
    winnerMap = mapf.getMap(980000403);
    loserMap = mapf.getMap(980000404);
    blueParty = null;
    redParty = null;
    var instanceName = "cpq5";
    eim = em.newInstance(instanceName);
    instanceId++;
    var portal = reviveMap.getPortal("pt00");
    portal.setScriptName("MCrevive5");
