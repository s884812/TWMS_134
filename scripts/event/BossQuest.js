...
function playerExit(eim, player) {
    ...
    player.getClient().getSession().write(tools.MaplePacketCreator.serverNotice(6, "[The Boss Quest] Your current points have been awarded, spend them as you wish. Better luck next time!"));
